  ...
  const experiences: ExperienceItem[] = [
    {
      ...
      technologies: ['React.js', 'JavaScript', 'Material UI', 'SCSS', 'REST APIs', 'State Management'],
    },
    {
      title: 'Front-End Developer',
      ...
      technologies: ['React.js', 'Node.js', 'SEO Optimization', 'Google Analytics', 'IzooTo'],
    },
    {
      title: 'Front-End Developer',
      ...
      technologies: ['Angular', 'Ionic Framework', 'Bootstrap', 'HTML5', 'CSS3', 'JavaScript'],
    },
    {
      ...
      technologies: ['React.js', 'Tailwind CSS', 'UI/UX Design', 'Performance Optimization'],
    },
  ];
        ...
        <Card className="card-elegant p-8 mt-16 bg-gradient-primary text-white animate-fade-up">
          <CardContent className="p-0">
            ...
            <div className="grid md:grid-cols-4 gap-6 text-center">
              <div>
                <div className="text-3xl font-bold mb-2">2.6+</div>
